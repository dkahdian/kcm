...
% Generated: 2026-01-09T00:26:54.839Z
% 
...
% =============================
\begin{claim}
$CNF$ is not polynomial-time transformable to $d$-$DNNF$ unless the polynomial hierarchy collapses \citet{Cadoli_1997,Selman_1996,Darwiche_2002}
\end{claim}
\begin{proofsketch}
The existence of polysize knowledge compilation functions for clausal entailment implies the collapse of the polynomial hierarchy. Also, note that $d$-$DNNF$ supports a polynomial-time clausal entailment test. If $CNF$ could be polynomial-time transformed to $d$-$DNNF$, then we could perform a clausal entailment test with any $CNF$ sentence by transforming it to a $d$-$DNNF$ clause.
\end{proofsketch}

\begin{claim}
$CNF$ is not polynomial-time transformable to $DNNF$ unless the polynomial hierarchy collapses \citet{Selman_1996,Cadoli_1997,Darwiche_2002}
\end{claim}
\begin{proofsketch}
The existence of polysize knowledge compilation functions for clausal entailment implies the collapse of the polynomial hierarchy. Also, note that $DNNF$ supports a polynomial-time clausal entailment test. If $CNF$ could be polynomial-time transformed to $DNNF$, then we could perform a clausal entailment test with any $CNF$ sentence by transforming it to a $DNNF$ clause.
\end{proofsketch}
...
\begin{claim}
$PI$ has unknown transformation to $d$-$DNNF$ \citet{Darwiche_2002}
\end{claim}
\begin{proofsketch}
This is listed as an open problem in A Knowledge Compilation Map (2002).
\end{proofsketch}
...
\begin{claim}
$PI$ has unknown transformation to $DNNF$ \citet{Darwiche_2002}
\end{claim}
\begin{proofsketch}
This is listed as an open problem in the Knowledge Compilation Map (2002).
\end{proofsketch}
...
\end{claim}
\begin{proofsketch}
This is shown in Proposition 7 and Theorem 9.
\end{proofsketch}
...
% Reference ID: __NO_REFERENCE__
% =============================
\begin{claim}
$CNF$ is polynomial-time transformable to $NNF$
\end{claim}
\begin{proofsketch}
...
\begin{claim}
$CNF$ is not quasi-polynomial-time transformable to $PI$
\end{claim}
\begin{proofsketch}
...
\begin{claim}
$d$-$DNNF$ is not quasi-polynomial-time transformable to $MODS$
\end{claim}
\begin{proofsketch}
...
\begin{claim}
$DNF$ is not polynomial-time transformable to $d$-$DNNF$ unless the polynomial hierarchy collapses
\end{claim}
\begin{proofsketch}
...
\begin{claim}
$IP$ is not quasi-polynomial-time transformable to $MODS$
\end{claim}
\begin{proofsketch}
