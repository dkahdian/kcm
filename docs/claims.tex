...
% Generated: 2026-02-21T00:06:44.092Z
% 
...
\end{claim}
\begin{claimdescription}
Shown by Proposition 3.10 of \citet{Amarilli_2018} (TODO: write intuitive explanation, not just a pointer)
\end{claimdescription}
...
% =============================
\begin{claim}
$SDD$ is not quasi-polynomial-time compilable to $OBDD$ \citet{Bryant_1986,Bova_2016_a}
\end{claim}
\begin{claimdescription}
...
% =============================
\begin{claim}
$OBDD$ is polynomial-time compilable to $SDD$ \citet{Darwiche_2011}
\end{claim}
\begin{claimdescription}
As established by \citet{Darwiche_2011}, every $OBDD$ is a right-linear $SDD$. Thus, $SDD$ strictly generalizes $OBDD$.
\end{claimdescription}
