...
% Generated: 2026-04-07T00:00:00.000Z
%
...
\begin{definition}[id=boolean-formula]\label{kdef:boolean-formula}
...
\begin{definition}[id=representation-language]\label{kdef:representation-language}
...
\begin{definition}[id=language-family]\label{kdef:language-family}
...
\begin{definition}[id=succinctness-language]\label{kdef:succinctness-language}
...
\begin{definition}[id=succinctness-family]\label{kdef:succinctness-family}
...
\begin{definition}[id=tractability]\label{kdef:tractability}
\textbf{Tractability} \\
...
\begin{definition}[id=query-operation]\label{kdef:query-operation}
...
\begin{definition}[id=transformation-operation]\label{kdef:transformation-operation}
