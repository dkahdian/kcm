...
% Generated: 2026-04-02T02:24:42.190Z
%
...
Requires that each pair $(x_i, y_i)$ has equal truth values. An \langref{OBDD\_<} with interleaved order $x_1 < y_1 < \cdots < x_n < y_n$ is polynomial, but a separated order $x_1 < \cdots < x_n < y_1 < \cdots < y_n$ forces exponential size. \citet{Darwiche_2002}
\end{definition}
