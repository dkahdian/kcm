...
\status{\nopolyunknownquasi}
\begin{description}
A polynomial-time forgetting procedure for \thislang would turn every \langref{DNF} representation into an equivalent \thislang representation of polynomial size in the input \langref{DNF} after introducing fresh selectors and forgetting them. This contradicts \nocompilespoly{\langref{DNF}}{\thislang} \citep{TCZ_Forthcoming}. \citep{Darwiche_2002,VanDenBroeck_2015}
\end{description}
\end{batchclaim}
