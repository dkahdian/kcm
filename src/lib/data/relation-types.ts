...
function getEndpointStyleForStatus(status: string | null): { arrow: any, dashed?: boolean, isDouble?: boolean } {
  ...
  switch (status) {
    ...
    case 'not-poly':
      // Not polynomial (generated by polytime-vs-not filter)
      // Same as no-quasi: filled square
...
export const relationTypes: KCRelationType[] = [
  ...
  },
  {
    ...
    name: 'Not Polynomial',
    label: '⊄_p',
    description: 'Not polynomial (generated by "Polytime vs not polytime" filter)',
    style: {
      lineStyle: 'solid',
      width: 2,
      targetStyle: { arrow: 'square', dashed: false },
